...
public class Task6Test {
    ...
    void onesBiggestWeightTest1(){
        ...
        Map<Type, Animal> ans = testObj.onesBiggestWeight(animals);

        assertThat(ans).isEqualTo(Map.of(Type.DOG,animals.get(5),Type.CAT,animals.get(7), Type.FISH,animals.get(8),
            Type.SPIDER, animals.get(9)));
    }
}
