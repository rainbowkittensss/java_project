...
public class Task17Test {
    ...
    void whoBitesTest1() {
        ...
        Boolean ans = testObj.whoBites(animals);
    ...
    void whoBitesTest2(){
        List<Animal> animals = List.of(
            new Animal("Sharickk", Type.DOG, Sex.M, 10, 140, 15, true),
            new Animal("Nemo", Type.SPIDER, Sex.M, 6, 2, 2, true),
            new Animal("Oatmeal", Type.SPIDER, Sex.F, 11, 130, 9, true),
            new Animal("Tails", Type.DOG, Sex.F, 4, 25, 12, false),
            new Animal("Big", Type.DOG, Sex.F, 1, 25, 30, false),
            new Animal("Huge", Type.DOG, Sex.F, 3, 25, 40, false),
            new Animal("Star", Type.SPIDER, Sex.F, 4, 127, 20, true),
            new Animal("Kotishe", Type.SPIDER, Sex.F, 5, 27, 60, true),
            new Animal("Dory", Type.FISH, Sex.M, 2, 2, 3, false),
            new Animal("Spidey", Type.FISH, Sex.M, 8, 2, 6, false)
        );
    ...
    void whoBitesTest3(){
        List<Animal> animals = List.of(
            new Animal("Sharickk", Type.DOG, Sex.M, 10, 140, 15, true),
            new Animal("Nemo", Type.DOG, Sex.M, 6, 2, 2, true),
            new Animal("Oatmeal", Type.DOG, Sex.F, 11, 130, 9, true),
            new Animal("Tails", Type.DOG, Sex.F, 4, 25, 12, false),
            new Animal("Big", Type.DOG, Sex.F, 1, 25, 30, false),
            new Animal("Huge", Type.DOG, Sex.F, 3, 25, 40, false),
            new Animal("Star", Type.SPIDER, Sex.F, 4, 127, 20, true),
