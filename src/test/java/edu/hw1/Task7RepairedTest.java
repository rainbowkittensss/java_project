...
public class Task7RepairedTest {
    @Test
    ...
    void task_7Testing() {
        ...
        for (int i = 0; i < results_left_right[0].length; ++i) {
            answers_left_right[0][i] = Task7Repaired.rotateLeft(numbers_and_moves[0][i], numbers_and_moves[1][i]);
            answers_left_right[1][i] = Task7Repaired.rotateRight(numbers_and_moves[0][i], numbers_and_moves[1][i]);
        }
